...
app.post('/api/generate', async (req, res) => {
  try {
    ...
    // 生成标题
    const titlesPrompt = `你是一个小红书千万粉丝博主兼心理学大师。请根据关键词"${keyword}"，生成10个让人忍不住点击的标题。

## 心理学原理（必须应用）：

1. **损失厌恶** - "别再浪费钱了"、"停止无效努力"
2. **稀缺效应** - "最后机会"、"仅限今天"
3. **社会认同** - "万人都在用"、"朋友圈刷屏"
4. **好奇心缺口** - "你绝对想不到"、"真相是..."
5. **权威偏见** - "10年经验总结"、"权威认证"
...
**损失厌恶类：**
- "别再浪费钱了！这个${keyword}才是..."
- "停止无效努力！${keyword}的正确姿势"
- "${keyword}的3个致命错误，90%的人都在犯"

**稀缺效应类：**
- "最后机会！这个${keyword}我要藏不住了"
- "仅限今天：${keyword}的隐藏玩法"
- "${keyword}内部价，仅限前100名"

**社会认同类：**
- "朋友圈都在用！这个${keyword}凭什么火？"
- "万人实测！这个${keyword}到底值不值得？"
- "全平台刷屏！${keyword}凭什么这么火？"

**好奇心缺口类：**
- "你绝对想不到，这个${keyword}竟然..."
- "真相了！${keyword}商家不会告诉你的秘密"
- "${keyword}的那些坑，看完省下一个亿"

**权威偏见类：**
- "10年经验总结：${keyword}的终极指南"
- "权威认证！这个${keyword}凭什么拿第一？"
- "专家都在用！${keyword}的正确打开方式"
...
**情绪共鸣类：**
- "破防了😭这个${keyword}让我哭死"
- "救命🆘这个${keyword}我后悔没早点知道"
- "真的会谢🙏这个${keyword}太绝了"

**数字冲击类：**
- "30天！${keyword}让我改变这么大"
- "省了5000！${keyword}的真实体验"
- "3个方法！${keyword}效果翻10倍"

**争议话题类：**
- "${keyword}是智商税？我亲自测试了30天"
- "不吹不黑：${keyword}到底值不值得？"
- "${keyword}翻车现场？真相是这样的"
